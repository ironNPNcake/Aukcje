...
<asp:Menu ID="Menu1" runat="server" Orientation="Horizontal" Height="40px" BackColor="#D0D0D0" DynamicHorizontalOffset="2" Font-Names="Verdana" Font-Size="Medium" ForeColor="#666666" StaticSubMenuIndent="10px" OnMenuItemClick="Menu1_MenuItemClick" Font-Bold="True">
